...
var SorobanProject = () => {
    return (
        ...
        <h3 className="projectHeader"> <a target="_blank" href="http://www.viscity.org"> Exercist </a> </h3>
        <div className="projectContent">
            ...
            <p className="projectDescription"> Exercist is a <a href="https://reactjs.org/">React</a> &amp; 
